-- Tworzenie sekwencji dla visitor_id
CREATE SEQUENCE visitor_id_seq
    START WITH 100
    INCREMENT BY 10;

-- Tworzenie tabeli visitors
CREATE TABLE visitors (
    visitor_id INT DEFAULT NEXT VALUE FOR visitor_id_seq PRIMARY KEY,
    employee_id NUMERIC(6, 0) NOT NULL,  -- U¿yj tego samego typu co w tabeli employees
    company VARCHAR(255),
    people_number INT,
    parking BIT,
...
-- Dodanie danych o odwiedzaj¹cych dla RSM
...
-- Dodanie danych o odwiedzaj¹cych dla KPMG
INSERT INTO visitors (employee_id, company, people_number, parking, enter_datetime, exit_datetime)
